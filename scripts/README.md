...
The bootstrap scripts validate Docker, preserve an existing `.env.development`, build and start the complete Compose environment, apply the current Alembic head, and run the containerized verifier.
